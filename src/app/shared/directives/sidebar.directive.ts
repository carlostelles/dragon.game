import {AfterViewInit, ChangeDetectorRef, Directive, ElementRef, EventEmitter, HostListener, OnInit, Output, Renderer2} from '@angular/core';
    ...
    ngAfterViewInit() {
        ...
        if ($sidebar_img_container.length !== 0 && $sidebar_img !== undefined) {
            const style =
                ...
                'filter: contrast(0);';
            this.renderer.setAttribute($sidebar_img_container, 'style', style);
        }
